...
import _styles from "./PriceCard.module.css";
...
export function PriceCard({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "coaching-price-card-wrapper")}
      tag="div"
    >
      <_Builtin.Block
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "coaching-price-card-heading-wrapper")}
          tag="div"
        >
          <_Builtin.Block
        ...
        <_Builtin.Block className={_utils.cx(_styles, "list-slots")} tag="div">
