...
export function DashboardNav({
  ...
  return (
    <_Component className={_utils.cx(_styles, "navbars-dashboard")} tag="div">
      <_Builtin.Block
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.HtmlEmbed
                className={_utils.cx(_styles, "dashboard-nav-icon", "fill")}
            ...
            >
              <_Builtin.DropdownToggle
                className={_utils.cx(_styles, "dashboard-drop-toggle")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "dashboard-nav-links")}
              ...
              <_Builtin.DropdownList
                className={_utils.cx(_styles, "dashboard-more-list")}
                tag="nav"
              >
                <_Builtin.Block
          ...
          <_Builtin.Block tag="div">
            ...
            >
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "notifiication-dropdown")}
                tag="div"
                data-hover={false}
                data-delay={0}
              >
                ...
                <_Builtin.DropdownList
                  className={_utils.cx(_styles, "notification-drop-list")}
                  tag="nav"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "notification-list-wrapper")}
                    tag="div"
                  >
                    <_Builtin.Block
              ...
              >
                ...
                <_Builtin.DropdownList
                  className={_utils.cx(_styles, "dashboard-user-list")}
                  tag="nav"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dashboard-more-wrapper")}
